...
public class Fotocamera {
    ...
    public Fotocamera(Long id, String posizione, List<Immagine> immagini){
        this.id = id;
        this.posizione = posizione;
        this.immagini = immagini;
    }

    public Fotocamera(Long id, String posizione, Immagine immagine){
        this.id = id;
        this.posizione = posizione;
    ...
    public Fotocamera(Long id, String posizione, Float mediaMacchine, Float mediaCamion, Float mediaMoto){
        this.id = id;
        this.posizione = posizione;
...
//
     ...
     */
    interface FotocameraSenzaMedie{
        Long getId();
        String getPosizione();
    ...
    interface FotocameraConIdEPosizione{
        Long getId();
        String getPosizione();
        void setId(Long id);
        void setPosizione(String posizione);
